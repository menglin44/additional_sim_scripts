setwd("/share/hennlab/data/SA_sim/sim/nama/4pop_complex/")
...
SumStat <- function(TrajFile){
  ...
  #run mssel  
  system(paste("/share/hennlab/progs/Meng_mssel_programs/mssel ", nsam.total, " 1 ", nanc.total, " ", nsel.total, " /share/hennlab/data/SA_sim/trajectories/nama/Nama_4popComplex_traj/", TrajFile, 
