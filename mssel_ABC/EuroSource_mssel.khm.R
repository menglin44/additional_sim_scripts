setwd("/share/hennlab/data/SA_sim/sim/khm/Euro_mig/")
...
SumStat <- function(TrajFile){
  ...
  #run mssel
  system(paste("/share/hennlab/progs/Meng_mssel_programs/mssel ", nsam.total, " 1 ", nanc.total, " ", nsel.total, " /share/hennlab/data/SA_sim/trajectories/khm/Khm_EuroMigOnly_traj/", TrajFile, 
