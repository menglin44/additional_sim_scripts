setwd("/home/mlin/data/Coalescent/4pop_complex/khm/trajectories/")
...
for (i in 1:100 ){ # each s2 has 100 trajectories
  ...
  system(paste("timeout 300 /home/mlin/progs/Meng_mssel_programs/traj4pop 1 0.5 ", nsam, " ", nder, " ", 2*s2, " 446 ", mEP, " ", tEP, " 0.12 7 ", mPK, " " ,tPK, " 100 38 0.13 14 ", random, " | /home/mlin/progs/Meng_mssel_programs/stepftn4pop > s2_", s2, "_i",i,"_R",random,"_task",job,".traj", sep=""))
