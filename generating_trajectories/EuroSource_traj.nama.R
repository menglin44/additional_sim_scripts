setwd("/home/mlin/data/Coalescent/EuroMig_only/Nama/trajectories/")
...
for (i in 1:100 ){ # each s2 has 100 trajectories
  ...
  # trajc nrep s1 s2 h N1 N2 t1 t2 m nsam nder seed 
  system(paste("timeout 300 /home/mlin/progs/Meng_mssel_programs/traj2pop_wBantu 1 0.16 ", 2*s2, " 0.5 10000 10000 446 10 0.17 322 172 ", random, " | /home/mlin/progs/Meng_mssel_programs/stepftn3pop > s2_", s2, "_i",i,"_R",random,"_task",job,".traj", sep=""))
